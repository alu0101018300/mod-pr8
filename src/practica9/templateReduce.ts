...
/**
 * Clase hija que se encarga de hacer la operación de resta
 */
export class ReduceSubstract extends ReduceOptions {
  /**
  ...
  /**
   * Inicializador del acumuador, en este caso, como se trata de una resta
   * se inicializa en 0.
   */
  ...
  /**
   * Realización de la operación de la resta, recorriendo todos los valores
